    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=start" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/logo-blue2.png" alt="Logo"> 
          <span style="font-size:20px">FarmaMexico</span>
        </a>
      ...
      <div class="content-wrapper">
        ...
        <?php include_once($_SERVER["DOCUMENT_ROOT'"].'/home3/cuartapr/public_html/content.php');?>
